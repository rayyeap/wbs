CLASS zcl_profitcenter_sap_query DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
  PRIVATE SECTION.
   TYPES ty_response_tab TYPE STANDARD TABLE OF zcdi_profitcenter_sap_vh WITH EMPTY KEY.
ENDCLASS.



CLASS zcl_profitcenter_sap_query IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    TRY.
        ...
        DATA: lt_create          TYPE STANDARD TABLE OF  zcdi_profitcenter_sap_vh WITH EMPTY KEY,
              lt_tab             TYPE STANDARD TABLE OF  zcdi_profitcenter_sap_vh WITH EMPTY KEY,
              ls_tab             LIKE LINE OF lt_tab,
              ls_return          TYPE ty_return,
              ls_controllingarea TYPE ty_controllingarea,
              lv_kokrs TYPE c LENGTH 4.

         lv_kokrs = ls_controllingarea-kokrs = 'PET1'.
