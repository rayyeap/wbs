CLASS zcl_companycode_cfin_query DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
  PRIVATE SECTION.
    TYPES ty_response_tab TYPE STANDARD TABLE OF zcdi_company_cfin_vh WITH EMPTY KEY.
ENDCLASS.



CLASS zcl_companycode_cfin_query IMPLEMENTATION.
